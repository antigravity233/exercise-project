...
window.addEventListener('scroll', srollActive)
...
// We validate the user perviously chose a topic
if (selectedTheme)
{
...
themeButton.addEventListener('click', () =>{
    ...
    // We save thr theme and current icon that the user choose
    localStorage.setItem('selected-theme', getCurrentTime())
